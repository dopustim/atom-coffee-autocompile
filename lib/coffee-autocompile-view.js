...
function createView() {
  ...
  view.classList.add('status-coffee-autocompile', 'inline-block');
...
export function showView(type, msg, detail) {
  ...
  if(view.style.display == 'none')
    setTimeout(hideView, atom.config.get('coffee-autocompile.statusBarMessageTimeout'));
  show(view);
}
